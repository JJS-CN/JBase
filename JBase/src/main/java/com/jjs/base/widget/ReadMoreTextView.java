...
public class ReadMoreTextView extends AppCompatTextView {
    ...
    private int trimLength;//文本长度
    private CharSequence trimCollapsedText;//视图折叠时，更多按钮文本
    private CharSequence trimExpandedText;//视图展开时，缩起按钮文本
    private ReadMoreClickableSpan viewMoreSpan;
    private int colorClickableText; // 可点击文字的颜色
    private boolean showTrimExpandedText;//是否展示缩起按钮
